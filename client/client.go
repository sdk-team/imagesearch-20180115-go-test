...
func (s *SearchItemResponseBodyAuctionsAuction) SetProductId(v string) *SearchItemResponseBodyAuctionsAuction {
	s.ProductId = &v
	return s
}
...
type ItemAddQuery struct {
	InstanceName *string `json:"instanceName,omitempty" xml:"instanceName,omitempty" require:"true"`
}

func (s ItemAddQuery) String() string {
	return tea.Prettify(s)
}

func (s ItemAddQuery) GoString() string {
	return s.String()
}

func (s *ItemAddQuery) SetInstanceName(v string) *ItemAddQuery {
	s.InstanceName = &v
	return s
}
...
type ItemAddRequest struct {
	Headers map[string]*string `json:"headers,omitempty" xml:"headers,omitempty"`
	Query   *ItemAddQuery      `json:"query,omitempty" xml:"query,omitempty" require:"true"`
}

func (s ItemAddRequest) String() string {
	return tea.Prettify(s)
}

func (s ItemAddRequest) GoString() string {
	return s.String()
}

func (s *ItemAddRequest) SetHeaders(v map[string]*string) *ItemAddRequest {
	s.Headers = v
	return s
}

func (s *ItemAddRequest) SetQuery(v *ItemAddQuery) *ItemAddRequest {
	s.Query = v
	return s
}

type ItemAddResponseBody struct {
	RequestId *string `json:"RequestId,omitempty" xml:"RequestId,omitempty" require:"true"`
	Success   *bool   `json:"Success,omitempty" xml:"Success,omitempty" require:"true"`
	Message   *string `json:"Message,omitempty" xml:"Message,omitempty" require:"true"`
	Code      *int    `json:"Code,omitempty" xml:"Code,omitempty" require:"true"`
...
func (s ItemAddResponseBody) String() string {
	return tea.Prettify(s)
}

func (s ItemAddResponseBody) GoString() string {
	return s.String()
}

func (s *ItemAddResponseBody) SetRequestId(v string) *ItemAddResponseBody {
	s.RequestId = &v
	return s
}

func (s *ItemAddResponseBody) SetSuccess(v bool) *ItemAddResponseBody {
	s.Success = &v
	return s
}

func (s *ItemAddResponseBody) SetMessage(v string) *ItemAddResponseBody {
	s.Message = &v
	return s
}

func (s *ItemAddResponseBody) SetCode(v int) *ItemAddResponseBody {
	s.Code = &v
	return s
}
...
type ItemAddResponse struct {
	Headers map[string]*string   `json:"headers,omitempty" xml:"headers,omitempty" require:"true"`
	Body    *ItemAddResponseBody `json:"body,omitempty" xml:"body,omitempty" require:"true"`
}

func (s ItemAddResponse) String() string {
	return tea.Prettify(s)
}

func (s ItemAddResponse) GoString() string {
	return s.String()
}

func (s *ItemAddResponse) SetHeaders(v map[string]*string) *ItemAddResponse {
	s.Headers = v
	return s
}

func (s *ItemAddResponse) SetBody(v *ItemAddResponseBody) *ItemAddResponse {
	s.Body = v
	return s
}

type UploadPicQuery struct {
	Name *string `json:"name,omitempty" xml:"name,omitempty" require:"true"`
}

func (s UploadPicQuery) String() string {
	return tea.Prettify(s)
}

func (s UploadPicQuery) GoString() string {
	return s.String()
}

func (s *UploadPicQuery) SetName(v string) *UploadPicQuery {
	s.Name = &v
	return s
}
...
type UploadPicRequest struct {
	Headers map[string]*string `json:"headers,omitempty" xml:"headers,omitempty"`
	Query   *UploadPicQuery    `json:"query,omitempty" xml:"query,omitempty" require:"true"`
}

func (s UploadPicRequest) String() string {
	return tea.Prettify(s)
}

func (s UploadPicRequest) GoString() string {
	return s.String()
}

func (s *UploadPicRequest) SetHeaders(v map[string]*string) *UploadPicRequest {
	s.Headers = v
	return s
}

func (s *UploadPicRequest) SetQuery(v *UploadPicQuery) *UploadPicRequest {
	s.Query = v
	return s
}
...
func (s UploadPicResponse) String() string {
	return tea.Prettify(s)
}

func (s UploadPicResponse) GoString() string {
	return s.String()
}

func (s *UploadPicResponse) SetHeaders(v map[string]*string) *UploadPicResponse {
	s.Headers = v
	return s
}
...
func (client *Client) SearchItemWithOptions(request *SearchItemRequest, runtime *util.RuntimeOptions) (_result *SearchItemResponse, _err error) {
	...
	_body, _err := client.DoRequestWithAction(tea.String("SearchItem"), tea.String("2018-01-15"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("/item/search"), util.StringifyMapValue(tea.ToMap(request.Query)), request.Headers, nil, runtime)
	if _err != nil {
		return _result, _err
	}
...
func (client *Client) DeleteItemWithOptions(request *DeleteItemRequest, runtime *util.RuntimeOptions) (_result *DeleteItemResponse, _err error) {
	...
	_body, _err := client.DoRequestWithAction(tea.String("DeleteItem"), tea.String("2018-01-15"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("/item/delete"), util.StringifyMapValue(tea.ToMap(request.Query)), request.Headers, nil, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) AddItemWithOptions(request *AddItemRequest, runtime *util.RuntimeOptions) (_result *AddItemResponse, _err error) {
	...
	_body, _err := client.DoRequestWithAction(tea.String("AddItem"), tea.String("2018-01-15"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("/item/add"), util.StringifyMapValue(tea.ToMap(request.Query)), request.Headers, nil, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ItemAddWithOptions(request *ItemAddRequest, runtime *util.RuntimeOptions) (_result *ItemAddResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	_result = &ItemAddResponse{}
	_body, _err := client.DoRequestWithAction(tea.String("ItemAdd"), tea.String("2018-01-15"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("/item/add"), util.StringifyMapValue(tea.ToMap(request.Query)), request.Headers, nil, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) ItemAdd(request *ItemAddRequest) (_result *ItemAddResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	_result = &ItemAddResponse{}
	_body, _err := client.ItemAddWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
...
func (client *Client) UploadPicWithOptions(request *UploadPicRequest, runtime *util.RuntimeOptions) (_result *UploadPicResponse, _err error) {
	_err = util.ValidateModel(request)
	if _err != nil {
		return _result, _err
	}
	_result = &UploadPicResponse{}
	_body, _err := client.DoRequestWithAction(tea.String("UploadPic"), tea.String("2018-01-15"), tea.String("HTTPS"), tea.String("POST"), tea.String("AK"), tea.String("/test/test-body"), util.StringifyMapValue(tea.ToMap(request.Query)), request.Headers, nil, runtime)
	if _err != nil {
		return _result, _err
	}
	_err = tea.Convert(_body, &_result)
...
func (client *Client) UploadPic(request *UploadPicRequest) (_result *UploadPicResponse, _err error) {
	runtime := &util.RuntimeOptions{}
	_result = &UploadPicResponse{}
	_body, _err := client.UploadPicWithOptions(request, runtime)
	if _err != nil {
		return _result, _err
	}
	_result = _body
